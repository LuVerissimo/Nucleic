...
config :helix_app, HelixAppWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: HelixAppWeb.ErrorHTML, json: HelixAppWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: HelixApp.PubSub,
  live_view: [signing_salt: "PQfB5czk"]
...
config :helix_app, HelixApp.Mailer, adapter: Swoosh.Adapters.Local
